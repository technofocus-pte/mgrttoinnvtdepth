...
**Important**: Allow at least 60 minutes to deploy the on-premises
environment before you start this lab.
...
17. Switch to the **Server
    Manager** window. ![BrokenImage](./media/image28.png)
...
![BrokenImage](./media/image138.png)
...
![BrokenImage](./media/image145.png)
...
![BrokenImage](./media/image148.png)
...
&& sh onboard_agent.sh -w \\\*\*Workspace ID\*\*\\ -s \\\*\*Workspace
Key\\\*\* -d opinsights.azure.com+++

38. When Prompted select Yes and then press enter

![BrokenImage](./media/image150.png)

![BrokenImage](./media/image151.png)

39. The installation screens should appear as below.

![BrokenImage](./media/image152.png)

![A screenshot of a computer program Description automatically
generated](./media/image153.png)

40. Enter the following command, substituting **\< Workspace ID
    \>** with the value copied earlier

+++/opt/microsoft/omsagent/bin/service_control
restart \<Workspace ID\>+++

![BrokenImage](./media/image154.png)
